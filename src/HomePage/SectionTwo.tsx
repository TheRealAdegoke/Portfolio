...
const SectionTwo: React.FC<TextColorProps> = ({ selectedColor }) => {
  ...
  return (
    <section
      className="small:my-[80px] large:ml-[80px] mx-auto small:max-w-[800px] large:mt-[250px] tablet:mt-[250px]"
      id="SectionTwo"
    >
      <div
      ...
      <p
        className={`text-[rgba(255,255,255,0.5)] large:text-[18px] mb-[30px] ml-[20px] medium:max-w-[570px]`}
      >
